...
Итоговые категории строго соответствуют ТЗ:
...
Модуль создан рядом с существующим `WebServers`, но работает отдельно и не зависит от большого frontend/backend контура проекта.
